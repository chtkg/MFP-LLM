...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train ST-ALLM on Shanghai dataset")
    parser.add_argument(
        "--data-root",
        type=str,
        default=r"/home/pc/WorkSpace/wangchang/Data/shanghai",
    )
    parser.add_argument(
        "--llm-path",
        type=str,
        default=r"/home/pc/WorkSpace/wangchang/models/Llama-3.2-1B",
    )
    parser.add_argument(
        "--weather-csv",
        type=str,
        default=r"/home/pc/WorkSpace/wangchang/STALLM/stallm/data/shanghai_weather_daily.csv",
        help="Daily weather CSV for Shanghai; leave empty string to disable.",
    )
    ...
    parser.add_argument(
        "--save-dir",
        type=str,
        default=r"/home/pc/WorkSpace/wangchang/STALLM/outputs/shanghai_run1",
    )
    ...
    parser.add_argument(
        "--ablation-no-mlp",
        action="store_true",
        help="Ablation: w/o deep MLP regression head. Replace it with a single linear layer from LLM hidden to outputs.",
    )
...
def main() -> None:
    ...
    scaler, train_set, val_set, _ = build_shanghai_datasets(
        data_root=args.data_root,
        weather_csv=args.weather_csv or None,
    )
