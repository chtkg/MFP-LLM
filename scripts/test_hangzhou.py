...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Evaluate ST-ALLM on Hangzhou test split")
...
def main() -> None:
    ...
    scaler, train_set, _, test_set = build_hangzhou_datasets(
    ...
    # If horizon-wise metrics are available, print them separately.
    # Keys are like "mae_h1", "rmse_h2", ...
    for h in range(1, 5):
        mae_key = f"mae_h{h}"
